...
const enableAdmin = document.getElementById("admin-cmds");
const enableMeta = document.getElementById("show-metadata");
const searchButton = document.getElementById("search-cmd-btn");
...
function performSearch(settings) {
...
function renderCommands(searchResults, settings, parent) {
    ...
    for (let index in searchResults) {
        ...
        let aliases = createFieldElement("Aliases", entry.aliases, aliases => {
            ...
            let aliasElem = document.createElement("div");
...
function createFieldElement(fieldName, valueStr, valueFactory) {
    ...
    if (valueFactory == null) {
        ...
        let temp = valueFactory(valueStr);
        if (temp == null) {
            return null;
        }
        valueElement = temp;
...
function addMatchWeight(result, query, label, m) {
    if (query == label) {
